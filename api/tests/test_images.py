...
@pytest.mark.asyncio
async def test_upload_image_rejects_mismatched_magic_bytes(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_upload_image_accepts_valid_jpeg(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_upload_image_accepts_valid_png(client: AsyncClient) -> None:
...
@pytest.mark.asyncio
async def test_upload_image_rejects_mismatched_png(client: AsyncClient) -> None:
